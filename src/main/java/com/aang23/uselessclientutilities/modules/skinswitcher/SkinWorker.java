...
public class SkinWorker {
	...
	public static void enable() {
		Minecraft.getMinecraft().player
				.sendMessage(new TextComponentString(TextFormatting.GREEN + "Second skin layer enabled."));
		enabled = true;
	...
	public static void disable() {
		Minecraft.getMinecraft().player
				.sendMessage(new TextComponentString(TextFormatting.GREEN + "Second skin layer disabled."));
		enabled = false;
